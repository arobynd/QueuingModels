...
def ExecuteSATsimulation_MIPmodel(MIPnumber,SimData, SimDataAll, SimDataCheap, SimDataTrivial, dataSetPartition="10_90", simulationResultsDir="", virtualMachines=1,  instanceCapTime=0, instanceGroupSize=[40], BigM=False, searchTime = 60, GAPsize = 0.1,  stopWhenQueue=2, dequeueWhenNotScheduledMIP=0):
