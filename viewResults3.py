...
def printLatex(simData1,simData2,simData3):
    print str(int(simData1["Solved"].sum())) + " & " + str(int(simData1["WaitingTimeInQueue"].sum()))+" & " + \
          ...
          str(int(simData3["Solved"].sum())) + " & " + str(int(simData3["WaitingTimeInQueue"].sum())) + " \\\\ \hline "
...
def plotResultsTrivialValues(simResultsDir, dataSetPartition):
    ...
    DirResults = "SimulationResults/"+dataSetPartition+"/"+simResultsDir+"/"
    #
    DataFiles=[ pd.read_csv(DirResults + "FCFS_N_R_PredictedServiceTime_TrivialFeatures_Simulation.csv"),
...
def plotResultsCheapValues(simResultsDir, dataSetPartition):
    ...
    #plotTestsWaitingTime(DataFiles,DataNames,OverHead,DirResults+"plotWaitingTimeFromFiles.png")
    #plotTestsAttendedAndSolvedInstances(DataFiles,DataNames,DirResults + "plotAttendedAndSolvedInstancesFromFiles.png")
    printLatex(DataFiles[0],DataFiles[1],DataFiles[2])
...
plotResultsCheapValues("xVM_1_WaitingTime_1_300_interArrival_300",Test)
plotResultsCheapValues("xVM_1_WaitingTime_1_600_interArrival_300",Test)
plotResultsCheapValues("xVM_1_WaitingTime_1_1000_interArrival_300",Test)
plotResultsCheapValues("xVM_1_WaitingTime_1_1500_interArrival_3600",Test)
plotResultsCheapValues("xVM_1_WaitingTime_1_3600_interArrival_3600",Test)
plotResultsCheapValues("xVM_1_WaitingTime_1_500_interArrival_1000",Test)
plotResultsCheapValues("xVM_1_WaitingTime_1000_3000_interArrival_1000",Test)
plotResultsCheapValues("xVM_1_WaitingTime_1000_3000_interArrival_500",Test)
plotResultsCheapValues("xVM_1_WaitingTime_1000_3000_interArrival_400",Test)
plotResultsCheapValues("xVM_1_WaitingTime_1000_3000_interArrival_300",Test)
