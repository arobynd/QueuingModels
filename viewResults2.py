...
def printLatex2(simData1,simData2,simData3,simData4,simData5,simData6,simData7,simData8,simData9,simData10,simData11,simData12):
    nombre="FCFS+N"
    maximo=int(simData1["Solved"].sum())
    if int(simData2["Solved"].sum()) > maximo:
        maximo=int(simData2["Solved"].sum())
        nombre="FCFS+H"
    if int(simData3["Solved"].sum()) > maximo:
        maximo = int(simData3["Solved"].sum())
        nombre="FCFS(C)+N"
    if int(simData4["Solved"].sum()) > maximo:
        maximo = int(simData4["Solved"].sum())
        nombre="FCFS(C)+H"
    if int(simData5["Solved"].sum()) > maximo:
        maximo = int(simData5["Solved"].sum())
        nombre="SJF(R)+N"
    if int(simData6["Solved"].sum()) > maximo:
        maximo = int(simData6["Solved"].sum())
        nombre="SJF(R)+H"
    if int(simData7["Solved"].sum()) > maximo:
        maximo = int(simData7["Solved"].sum())
        nombre="SJF(R-C)+N"
    if int(simData8["Solved"].sum()) > maximo:
        maximo = int(simData8["Solved"].sum())
        nombre="SJF(R-C)+H"
    if int(simData9["Solved"].sum()) > maximo:
        maximo = int(simData9["Solved"].sum())
        nombre="MIP-1(R)+H"
    if int(simData10["Solved"].sum()) > maximo:
        maximo = int(simData10["Solved"].sum())
        nombre="MIP-1(R)+P"
    if int(simData11["Solved"].sum()) > maximo:
        maximo = int(simData11["Solved"].sum())
        nombre="MIP-2(R-C)+H"
    if int(simData12["Solved"].sum()) > maximo:
        maximo = int(simData12["Solved"].sum())
        nombre="MIP-2(R-C)+P"
