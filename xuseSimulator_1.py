...
def ExecuteSATsimulation_MIPmodel(SimData, SimDataAll, SimDataCheap, SimDataTrivial, dataSetPartition="10_90", simulationResultsDir="", virtualMachines=1,  instanceCapTime=0, instanceGroupSize=[40], BigM=False, searchTime = 120, GAPsize = 0.1,  stopWhenQueue=2):
...
def Test(simResultsDir="Simulation", dataSetPartition="10_90", instanceMaximumExpectedWaitingTime=0, instanceGroupSize=[40],
    ...
    ExecuteSATsimulation_MIPmodel(SimData = SimData ,
                                  SimDataAll = SimDataAll ,
                                  SimDataCheap = SimDataCheap ,
                                  SimDataTrivial = SimDataTrivial,
                                  dataSetPartition=dataSetPartition,
...
# PredictionsInputFileR = "../myTrainedModelsAndResults/" + Partition + "/1." + instanceType + "(minisat)(regression)(predictions)all.csv"
# PredictionsInputFileAllR = "../myTrainedModelsAndResults/" + Partition + "/1." + instanceType + "(minisat)(regression)(predictions)all.csv"
# PredictionsInputFileTrivialR = "../myTrainedModelsAndResults/" + Partition + "/2." + instanceType + "(minisat)(regression)(predictions)trivial.csv"
# PredictionsInputFileCheapR = "../myTrainedModelsAndResults/" + Partition + "/3." + instanceType + "(minisat)(regression)(predictions)cheap.csv"
# PredictionsInputFileC = "../myTrainedModelsAndResults/" + Partition + "/4." + instanceType + "(minisat)(classification)(predictions)all.csv"
# PredictionsInputFileAllC = "../myTrainedModelsAndResults/" + Partition + "/4." + instanceType + "(minisat)(classification)(predictions)all.csv"
# PredictionsInputFileTrivialC = "../myTrainedModelsAndResults/" + Partition + "/5." + instanceType + "(minisat)(classification)(predictions)trivial.csv"
# PredictionsInputFileCheapC = "../myTrainedModelsAndResults/" + Partition + "/6." + instanceType + "(minisat)(classification)(predictions)cheap.csv"
#
# Test(simResultsDir="VM_"+str(virtualMachine)+"_WaitingTime_"+str(waitingL)+"_"+str(waitingU)+"_interArrival_"+str(interMax)+"_"+datetime.now().strftime('#%Y_%m_%d_%H_%M_%S'),
